			...
			<Container id="infoProfile" className="d-flex justify-content-center pt-3 my-5">
				<Form onSubmit={onUpdate} className="w-50">
					...
					<Form.Select ref={cityField} aria-label="Default select example">
						...
						<option selected={user.city==="jakarta"?"selected":""} value="jakarta">Surabaya</option>
						<option selected={user.city==="semarang"?"selected":""} value="semarang">Bandung</option>
						<option selected={user.city==="bekasi"?"selected":""} value="bekasi">Jakarta</option>
					</Form.Select>
					<Form.Group className="mb-3" controlId="formBasicText">
						<Form.Label
						>Alamat*</Form.Label>
